...
# inventory = [
#     {"name": "Cheese Casserole", "quantity": 500, "price": 10, "id": 1, "image": "cheesecasserole", "description":"Enjoy this delectable home-style meal cooked by only the most homely of chefs. This bundle of cheesy goodness will melt your taste buds through the sheer potency of its existence."},
...
@app.route('/inventory')
def getAllInventory():
    inventory = client.scan(TableName=TABLE_NAME)
